					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								...
								<small><a href="${path}/food/add">添加食材</a></small>
							</h1>
						</div><!-- /.page-header -->
						...
						<div class="row">
							<div class="col-xs-12">
											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td>${row.type}</td>
														<td class="hidden-480">${row.unit}</td>
														<td class="hidden-480">${row.weight}</td>
													...
													<script>
													function edit(domid){
														location.href="${path}/food/edit/"+domid;
														
													}
													function del(domid){
														if(confirm("确定删除吗?")){
															location.href="${path}/food/delete/"+domid;
														}
													}
													</script>
												</tbody>
								...
								<c:set var="actionUrl" value="${path}/food/" />
